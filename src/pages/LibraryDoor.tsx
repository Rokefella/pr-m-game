      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: '50%',
            background:
              'radial-gradient(circle, rgba(74,158,255,0.55) 0%, rgba(74,158,255,0.25) 45%, transparent 70%)',
        ...
        >
          <defs>
            ...
            <linearGradient id="doorStroke" x1="0" y1="0" x2="1" y2="0">
              ...
              <stop offset="50%" stopColor="#8ec6ff" />
          ...
          <path
            ...
            stroke="none"
          />
          {/* Outer arch blue stroke with glow */}
          <path
            d="M20,320 L20,110 Q20,20 110,20 Q200,20 200,110 L200,320"
            fill="none"
          ...
          <line
            ...
            x2="110"
            y2="320"
            stroke="rgba(142,198,255,0.18)"
            strokeWidth="1"
          />
          {/* Door handles */}
          <circle cx="96" cy="178" r="4" fill="rgba(142,198,255,0.55)" />
          <circle cx="124" cy="178" r="4" fill="rgba(142,198,255,0.55)" />
